...
for i, line in enumerate(lines):
    if "if getattr(self, 'arrastando_bisturi', False):" in line and "def eventFilter(self, obj, event):" in "".join(lines[max(0, i-50):i]):
        ...
        new_lines.append(indent + "    print('LOG-3D: arrastando_janelamento set to False')\n")
