...
with open('ui/textos_e_estilos.py', 'w', encoding='utf-8') as f:
...
with open('ui/config_presets.py', 'w', encoding='utf-8') as f:
    f.write('''# -*- coding: utf-8 -*-
...
print("Created ui/textos_e_estilos.py and ui/config_presets.py")
